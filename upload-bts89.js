// Upload video-bts8 and video-bts9 to Cloudinary
...
async function main() {
    await uploadVideo('public/komukuna-event/process/video-bts8.mp4', 'komukuna/process/video-bts8');
    await uploadVideo('public/komukuna-event/process/video-bts9.mp4', 'komukuna/process/video-bts9');
}
